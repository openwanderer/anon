...
def main(input_path, image_output_path, weights_path, image_extensions, face_threshold, plate_threshold,
    ...
    print(f"input_path {input_path} output {image_output_path} weights {weights_path} image_Extensions {image_extensions} face_threshold {face_threshold} weight_threshold {plate_threshold} write_josn {write_json} obf {obfuscation_parameters}")
